				...
				<div className="text-left mb-12">
					...
					<div className="flex flex-col sm:flex-row sm:items-start sm:gap-6 mb-8">
						<div className="flex-1">
							...
							<Reveal threshold={0.3} delay={0.1} duration={0.4}>
								<p
									id="about-description"
									className="text-lg text-muted-foreground max-w-2xl mb-4"
								>
									C&apos;est à l&apos;hôpital que j&apos;ai commencé mon
									parcours, et je conjugue maintenant cette pratique au suivi en
									libéral, pour un accompagnement au plus proche de votre
									quotidien.
								</p>
							</Reveal>
						...
						{/* Photo optimisée SEO */}
						<Reveal threshold={0.3} delay={0.2} duration={0.4}>
							...
							<Reveal threshold={0.2} delay={0.1} duration={0.4}>
								<div>
									...
									<p className="text-sm text-foreground/80">
										Diplômée en diététique et nutrition, je garantis des prises
										en charge rigoureusement scientifiques, et adaptées selon
										vos besoins individuels.
									</p>
								</div>
							</Reveal>
							<Reveal threshold={0.2} delay={0.2} duration={0.4}>
								<div>
									<h4 className="font-medium text-foreground mb-2">
										Suivi personnalisé
									</h4>
									<p className="text-sm text-foreground/80">
										...
										vos objectifs et votre mode de vie pour un accompagnement
										nutritionnel durable et efficace.
									</p>
								</div>
							</Reveal>
							<Reveal threshold={0.2} delay={0.3} duration={0.4}>
								<div>
									<h4 className="font-medium text-foreground mb-2">
									...
									<p className="text-sm text-foreground/80">
										...
										démarche respectueuse et votre relation à
										l&apos;alimentation pour retrouver le plaisir de manger.
									</p>
								</div>
							</Reveal>
							<Reveal threshold={0.2} delay={0.4} duration={0.4}>
								<div>
									<h4 className="font-medium text-foreground mb-2">
