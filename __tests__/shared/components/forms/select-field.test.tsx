...
jest.mock("@/shared/components/ui/select", () => ({
	...
	SelectTrigger: ({ children, onBlur, ...props }: any) => (
		<button data-testid="select-trigger" onBlur={onBlur} {...props}>
			{children}
		</button>
	),
...
describe("SelectField", () => {
	...
	it("should render required asterisk when required is true", () => {
		render(<SelectField label="Choose option" options={mockOptions} required />);
	...
	it("should disable select when disabled prop is true", () => {
		render(<SelectField label="Choose option" options={mockOptions} disabled />);
	...
	it("should associate label with select", () => {
		...
		expect(label).toHaveAttribute("htmlFor", "test-select");
	});
