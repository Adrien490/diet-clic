...
describe("ContactForm Component", () => {
	...
	it("should render form title for screen readers", () => {
		...
		const title = screen.getByRole("heading", { name: /Formulaire de contact/i });
	...
	it("should have proper accessibility attributes", () => {
		...
		const srDescription = screen.getByText(/Formulaire de contact pour prendre rendez-vous/);
	...
	it("should render data attributes for voice commands and AI", () => {
		...
		expect(form).toHaveAttribute("data-content-type", "contact-form-healthcare");
		expect(form).toHaveAttribute("data-ai-category", "healthcare-nutrition-booking");
