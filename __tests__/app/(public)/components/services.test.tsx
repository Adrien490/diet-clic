import { Services } from "@/app/(public)/components/services";
...
jest.mock("@/app/(public)/components/service-item", () => ({
...
describe("Services", () => {
	it("should render services section with correct structure", () => {
		...
		expect(section).toHaveAttribute("aria-label", "Prestations et services de diététique à Nantes");
	});

	it("should render main heading", () => {
		render(<Services />);

		expect(screen.getByText("Consultations diététique et nutrition à Nantes")).toBeInTheDocument();
	});
	...
	it("should render service description", () => {
		...
		expect(
			screen.getByText(/Consultations personnalisées et accompagnement nutritionnel/)
		).toBeInTheDocument();
	});
	...
	it("should render contact link", () => {
		...
		const contactLink = screen.getByRole("link", { name: /Réserver votre première consultation/ });
	...
	it("should have proper semantic structure", () => {
		...
		expect(section).toHaveAttribute("itemType", "https://schema.org/MedicalBusiness");
	});
	...
	it("should render screen reader description", () => {
		...
		const srText = screen.getByText(/Manon Chaillou propose des consultations de diététique à Nantes/);
	...
	it("should render subtitle correctly", () => {
		...
		expect(screen.getByText(/Consultations personnalisées et accompagnement nutritionnel/)).toBeInTheDocument();
	});
